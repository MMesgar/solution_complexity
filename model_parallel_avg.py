...
def train_model_average(rng,
    ...
    # replace word indecides with word vectors shape = (bacth_size,1, sent_h, sent_w) = (32,1,591,300)
    ...
    avg_output1 = T.mean(layer0_input1, axis=2, keepdims=True)
    avg_output2 = T.mean(layer0_input2, axis=2, keepdims=True)
    avg_output3 = T.mean(layer0_input3, axis=2, keepdims=True)
    
    #shape = (bacth_size, sent_w) = (32,300)
    avg_output1 = avg_output1.flatten(2)
    avg_output2 = avg_output2.flatten(2)
    avg_output3 = avg_output3.flatten(2)
    
    #shape = (bacth_size, sent_w+ sent_w+sent_w) = (32,900)
    layer1_input = debug_print(T.concatenate([avg_output1,avg_output2,avg_output3],1),'layer1_input',False)
    hidden_units[0] = 3*(sent_w)    
...
#    val_set_y = new_data[1][n_train_batches*batch_size:]
    ...
    avg_output2 = T.mean(test_layer0_input2, axis=2, keepdims=True)
    avg_output3 = T.mean(test_layer0_input3, axis=2, keepdims=True)
    ...
    test_layer1_input = debug_print(T.concatenate([avg_output1,avg_output2,avg_output3],1),'test_layer1_input',False)
...
if __name__=="__main__":
    ...
    for i, fold in enumerate(folds):
        ...
        perf, errors, labels_prob = train_model_average(rng,
                              datasets,
                              U,
                              lr_decay=0.95,
                              hidden_units=[1000,
